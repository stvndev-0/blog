...
ALLOWED_HOSTS = ['blog-proyect.up.railway.app']

CSRF_TRUSTED_ORIGINS = ['https://blog-proyect.up.railway.app']
...
CKEDITOR_CONFIGS = {
    'default': {
        'toolbar': 'full',
        'extraPlugins': ','.join([
            'uploadimage',  # El plugin que permite subir imágenes
            # puedes agregar otros plugins que necesites
        ]),
    },
}
